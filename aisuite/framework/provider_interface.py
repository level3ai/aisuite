...
class ProviderInterface:
    ...
    async def async_chat_completion_create(self, messages=None, model=None, temperature=0) -> None:
        """Create a chat completion using the specified messages, model, and temperature.
        ...
        """
        raise NotImplementedError(
            "Provider Interface has not implemented async_chat_completion_create()"
        )